...
mixin _$OrderState {
  ...
  set orderList(List<Order> value) => throw _privateConstructorUsedError;
...
abstract class $OrderStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({int counter, List<Order> orderList});
}
...
class _$OrderStateImpl implements _OrderState {
  _$OrderStateImpl({this.counter = 0, this.orderList = const []});
  ...
  @override
  String toString() {
    return 'OrderState(counter: $counter, orderList: $orderList)';
  }
...
abstract class _OrderState implements OrderState {
  factory _OrderState({int counter, List<Order> orderList}) = _$OrderStateImpl;
