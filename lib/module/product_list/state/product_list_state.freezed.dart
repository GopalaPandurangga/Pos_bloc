...
mixin _$ProductListState {
  ...
  set productList(List<Product> value) => throw _privateConstructorUsedError;
...
abstract class $ProductListStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({int counter, List<Product> productList});
}
...
class _$ProductListStateImpl implements _ProductListState {
  _$ProductListStateImpl({this.counter = 0, this.productList = const []});
  ...
  @override
  String toString() {
    return 'ProductListState(counter: $counter, productList: $productList)';
  }
...
abstract class _ProductListState implements ProductListState {
  factory _ProductListState({int counter, List<Product> productList}) =
